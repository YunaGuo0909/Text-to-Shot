...
class StageDiffusion(nn.Module):
    """Gaussian diffusion for a single-output stage (person OR camera)."""
    ...
    def p_losses(self, y_0, text_embed, shot_type=None, motion_type=None,
        ...
        return nn.functional.mse_loss(y_0_pred, y_0)

    def _predict_y0(self, y_t, t_batch, text_embed, shot_type=None,
                    motion_type=None, guidance_scale=1.0, person_traj=None):
    ...
    def p_sample(self, y_t, t, text_embed, shot_type=None, motion_type=None,
                 guidance_scale=1.0, person_traj=None):
        y_0_pred = self._predict_y0(y_t, t, text_embed, shot_type=shot_type,
