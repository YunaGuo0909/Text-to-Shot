...
PYTHONPATH=. python scripts/data/preprocess_et_data.py \
...
PYTHONPATH=. python scripts/data/prepare_amass.py \
...
PYTHONPATH=. python scripts/data/prepare_humanml3d.py \
    --amass-root /transfer/amassdata \
...
PYTHONPATH=. python scripts/data/merge_datasets.py \
...
python scripts/debug/diagnose_v6_issues.py --data-root /transfer/merged-v9b --max-samples 2000
